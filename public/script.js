document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchCourses(parameter_jadwal) {
        try {
            const response = await fetch(`https://jadwal-bima-production.up.railway.app/api/matkul?params=${parameter_jadwal}`);
    ...
    async function fetchSemesters() {
        try {
            const response = await fetch('https://jadwal-bima-production.up.railway.app/api/semester');
